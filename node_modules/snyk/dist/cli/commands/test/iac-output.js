...
exports.mapIacTestResponseToSarifResults = exports.mapIacTestResponseToSarifTool = exports.createSarifOutputForIac = exports.capitalizePackageManager = exports.getIacDisplayErrorFileOutput = exports.getIacDisplayedOutput = void 0;
...
function mapIacTestResponseToSarifResults(iacTestResponse) {
    return iacTestResponse.result.cloudConfigResults.map((iacIssue) => ({
        ruleId: iacIssue.id,
        message: {
            text: `This line contains a potential ${iacIssue.severity} severity misconfiguration affecting the ${iacTypeToText[iacIssue.type]} ${iacIssue.subType}`,
        },
        locations: [
            {
                physicalLocation: {
